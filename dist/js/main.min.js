"use strict";var langArr={"menu-1":{ru:"меню",en:"menu"},"menu-2":{ru:"скачать приложение",en:"download app"},"menu-3":{ru:"контакты",en:"contact us"},sign_up:{ru:"регистрация",en:"sign up"},h2:{ru:"Узнайте погоду во всем мире с помощью <span>Dark Weather!</span>",en:"Seing the weather of the whole world with <span>Dark Weather!</span>"},search:{ru:"искать здесь",en:"search here"},filter__text:{ru:"Фильтры",en:"Filters"},f1:{ru:"Теплее",en:"Coldest"},f2:{ru:"Холоднее",en:"Warmest"}};
